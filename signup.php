                ...
                <div class="card-text">
                    <form id="registraion_form" action="signup-process.php" method="post" name="reg-form">
                        <div class="form-group">
                            ...
                            <input type="text" name="phname" placeholder="Pharmacy Name" class="form-control form-control-sm mb-2" id="txt_phname" required>
                        </div>
                        <div class="form-group">

                            <input type="email" name="email" placeholder="Email address" class="form-control form-control-sm mb-2" id="txt_email" required>
                        </div>
                        <div class="form-group">
                            <input type="text" name="addr" placeholder="Address" class="form-control form-control-sm mb-2" id="txt_addr" required>
                        </div>
                        <div class="form-group">
                            <input type="text" name="phno" placeholder="Phone Number" class="form-control form-control-sm mb-2" id="txt_phno" required>
                        </div>
                        <div class="form-group">
                            <input type="text" name="phlicenseno" placeholder="Pharmacy License Number" class="form-control form-control-sm mb-2" id="txt_phlicense" required>
                        </div>
                        <div class="form-group">
                            <input type="password" placeholder="Password" name="psw" class="form-control form-control-sm mb-2" id="txt_password" required>
                        </div>
                        <div class="form-group">
                            <input type="password" placeholder="Confirm Password" name="cpsw" class="form-control form-control-sm mb-3" id="txt_cpassword" required>
                        </div>

                        <input type="checkbox" name="agree" id="agree">
                        <p>I agree to <a href="#">Terms of Service</a>and <a href="#">Privacy Policy</a></p>

                        <button type="submit" class="btn btn-primary btn-block" id="btn_register"><i class="fa fa-lock"></i> Sign up</button>
